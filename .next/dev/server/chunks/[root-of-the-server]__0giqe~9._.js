...
"[project]/app/api/conversation/end/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    const upstream = await fetch(backendUrl.replace(/\/+$/, "") + "/api/widget/conversation/end", {
        method: "POST",
        body: forward,
        cache: "no-store"
    });
    ...
    if (!upstream.ok) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: json.error ?? "Backend end request failed",
            upstream: json
        }, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0giqe~9._.js.map