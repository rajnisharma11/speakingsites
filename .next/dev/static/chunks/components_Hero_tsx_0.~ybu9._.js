...
function Hero() {
    ...
    const activeIndustryRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])("plumber");
    ...
    const liveAvatarSessionIdRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const userWantsMicOnRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(true);
    const avatarSpeakingMutedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    const lastStopReasonRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const sessionStartedAtRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const sessionLiveAtRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const startSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Hero.useCallback[startSession]": async (industry)=>{
            ...
            try {
                const requestToken = {
                    "Hero.useCallback[startSession].requestToken": async ()=>{
                        ...
                        if (!res.ok) {
                            const j = await res.json().catch({
                                "Hero.useCallback[startSession].requestToken": ()=>({})
                            }["Hero.useCallback[startSession].requestToken"]);
                ...
                for(let i = 0; i < attempts.length; i++){
                    if (attempts[i] > 0) {
                        ...
                        await new Promise({
                            "Hero.useCallback[startSession]": (r)=>setTimeout(r, attempts[i])
    ...
    const pickActiveVideoRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Hero.useCallback[pickActiveVideoRef]": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
            const isDesktop = window.matchMedia("(min-width: 1024px)").matches;
            return (isDesktop ? desktopVideoRef.current : mobileVideoRef.current) ?? desktopVideoRef.current ?? mobileVideoRef.current;
        }
    }["Hero.useCallback[pickActiveVideoRef]"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Hero.useEffect": ()=>{
            ...
            const attach = {
                "Hero.useEffect.attach": ()=>{
                    ...
                    console.log("[Hero] attaching stream to video element", {
                        isDesktop: ("TURBOPACK compile-time value", "object") !== "undefined" && window.matchMedia("(min-width: 1024px)").matches
                    });
                    ...
                    target.play().then({
                        ...
                        "Hero.useEffect.attach": (e)=>console.warn("[Hero] muted video.play() failed", e)
                    }["Hero.useEffect.attach"]);
                }
            }["Hero.useEffect.attach"];
            attach();
            ...
            return ({
                "Hero.useEffect": ()=>mql.removeEventListener("change", onChange)
            })["Hero.useEffect"];
        }
    }["Hero.useEffect"], [
        isStreamReady,
...
_s1(Hero, "XinTCh3AWKCLpWusRAVM9g+EWYc=");
_c2 = Hero;
var _c, _c1, _c2;
